...
import {
  ...
  Hour,
  HourText,
  CreateAppoinmentButton,
  CreateAppoinmentButtonText,
} from './styles';
  ...
  return (
    <Container>
      ...
      <Content>
        ...
        <CreateAppoinmentButton onPress={handleCreateAppointment}>
          <CreateAppoinmentButtonText>Agendar</CreateAppoinmentButtonText>
        </CreateAppoinmentButton>
      </Content>
    </Container>
  );
